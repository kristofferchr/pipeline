...
`,
		...
		t.Run(tc.name, func(t *testing.T) {
			gotInit, gotSteps, gotSidecars := convertScripts(images.ShellImage, images.ShellImageWin, []v1.Step{}, tc.sidecars, nil, false, false)
			gotInitScripts := ""
			if gotInit != nil {
